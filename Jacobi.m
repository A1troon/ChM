function [x1,niter,r] = Jacobi(a,b,c,f,tol,x1,maxiter)
    %tol-критерий точности
    %x0-начальное приближение к x
    %maxiter -максимальное число иттераций
    %niter-число итераций потребовавшихся для достижения критерия точности
    %r-векторнорм невязок на итерациях
    %проверка условий 
